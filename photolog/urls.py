...
#    url(r'^gallery/$', views.gallery_all, name='all_gallery'),
    url(r'^gallery/(?P<slug>[\-\d\w]+)/$', views.gallery_detail, name="gallery_detail"),
)
...
urlpatterns += patterns('',
    url(r'^photo_uploads/(.*)$',  'django.views.static.serve',
            {'document_root': settings.MEDIA_ROOT + settings.PHOTO_UPLOAD_FOLDER}, name='serve-image'),
)
